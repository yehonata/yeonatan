...
module.exports.run = async (bot, message, args) => {
  ...
  if (!message.member.hasPermissions('Muts_Members')) return message.channel.send("You need **mute members** permissions for use this command.")
  ...
  const muteembed = new Discord.RichEmbed()
    ...
    .setColor('#0d05ff')
    .setFooter("GG", "https://cdn.discordapp.com/avatars/453870812311584779/72734a7ab1876a3d63e565e70f378fc2.png?size=2048")
